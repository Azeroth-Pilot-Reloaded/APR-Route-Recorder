...
button:SetScript("OnEnter", function(self)
    ...
    AprRC:AddTooltipLine(GameTooltip, L["Open route workshop"], 1, 0.82, 0.4)
    AprRC:AddTooltipLine(GameTooltip, L["Drag to move"], 0.8, 0.8, 0.8)
    AprRC:AddTooltipLine(GameTooltip, L[AprRC.settings.profile.recordBarFrame.isRecording and "Recording" or "Recording stopped"], 1, 1, 1)
    GameTooltip:Show()
end)
