...
local allCommands = {
    ...
    { command = "isCompleted",   label = "Is Quest Completed On Account",    texture = iconPath .. "IsQuestCompletedOnAccount" },
    { command = "isUncompleted", label = "Is Quest Uncompleted On Accountt", texture = iconPath .. "IsQuestUncompletedOnAccount" },
