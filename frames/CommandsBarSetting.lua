...
local allCommands = {
    ...
    { command = "noaura",        label = "DontHaveAura",        texture = "Interface\\AddOns\\APR-Recorder\\assets\\icons\\DontHaveAura" },
    ...
    { command = "aura",          label = "HasAura",             texture = "Interface\\AddOns\\APR-Recorder\\assets\\icons\\HasAura" },
    { command = "spell",         label = "HasSpell",            texture = "Interface\\AddOns\\APR-Recorder\\assets\\icons\\HasSpell" },
