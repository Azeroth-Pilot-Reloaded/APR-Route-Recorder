...
assert(value("route conditions", '{ Class = { 8, "EVOKER" }, Race = { "Orc", "Troll" }, ClassNot = { 13 } }'))
assert(value("route conditions", '{ Class = {} }') == nil)
assert(value("route conditions", '{ Race = { "UnknownRace" } }') == nil)
