...
assert(Settings.results and #Settings.runButtons > 0)
...
assert(Settings.category == "all" and #Settings.runButtons == 1)
assert(Settings.runButtons[1]:GetUserData("command") == "bankdeposit")
